...
Well, _remind ourselves...._ Python installation in R is likely something you have 
...
R packages are installed with the same `conda install` command. Note that in
this case, package names are pre-pended with `r-`:
...
Taken from [this issue](https://stackoverflow.com/questions/52061664/install-r-package-from-github-using-conda),
...
If you have sudo permissions, we can use the `pak` package. The great things 
